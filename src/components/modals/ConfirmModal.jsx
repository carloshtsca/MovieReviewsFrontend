                ...
                <div className="flex items-center space-x-3 mt-3">
                    {busy ?
                        (
                            ...
                            <>
                                <button onClick={onConfirm} type='button' className={`${commonClass} bg-red-500`}>Confirm</button>
                                <button onClick={onCancel} type='button' className={`${commonClass} bg-blue-500`}>Cancel</button>
                            </>
                        )}
                </div>
            </div >
